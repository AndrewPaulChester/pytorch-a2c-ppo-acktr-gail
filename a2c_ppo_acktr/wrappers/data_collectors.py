...
class RolloutStepCollector(LogPathCollector):
    def __init__(
        ...
        self._rollouts = RolloutStorage(
            ...
            num_processes,
            shape,
            env.envs[0].symbolic_action_space,
...
class ThreeTierStepCollector(RolloutStepCollector):
    def __init__(
        ...
        self._low_rollouts = RolloutStorage(
            max_num_epoch_paths_saved,
            num_processes,
            shape,
            env.action_space,
        ...
        self._low_rollouts.obs[0].copy_(stored_obs)
        self._low_rollouts.to(self.device)

    def get_rollouts(self):
        return self._rollouts, self._low_rollouts
